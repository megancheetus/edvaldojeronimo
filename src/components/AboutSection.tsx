      ...
      <div className="container mx-auto px-6">
        <motion.div
          ...
          <div className="space-y-5 text-muted-foreground leading-relaxed text-base md:text-lg">
            ...
            <p>
              Como Clínico especialista em <strong className="text-foreground">Medicina de Família</strong>, resolvo a grande maioria das suas demandas de saúde de forma integral, promovendo prevenção real e tratamentos assertivos, sempre pautado nas melhores evidências científicas.
            </p>
            <p>
